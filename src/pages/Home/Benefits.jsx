    ...
    <section className="my-9 sm:my-11 md:my-13 lg:my-15">
      ...
      <div className="max-w-6xl mx-auto space-y-5 sm:space-y-6 md:space-y-7">
        {benefits.map((benefit, index) => (
          <motion.div
            key={benefit.id}
            className="bg-white rounded-2xl p-5 md:p-7 border border-gray-200 flex items-center gap-5 md:gap-7 min-h-[200px] hover:border-secondary/50 transition-all duration-300"
          ...
          >
            ...
            <div className="flex-1">
              <motion.h3
                className="text-xl md:text-2xl font-bold text-secondary mb-3 md:mb-4"
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
